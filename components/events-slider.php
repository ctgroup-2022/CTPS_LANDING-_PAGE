<section class="events-slider-section" id="events-slider">
    <!-- Section Heading -->
    ...
    <div class="circular-events-container">
        ...
        <div class="circular-event-card" id="event-notice">
        ...
        <div class="circular-event-card" id="event-spotlight">
        ...
        <div class="circular-event-card" id="event-activities">
